        ...
        <div className="mx-auto max-w-2xl  pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className=" mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                ...
                <div className="mx-auto imageContainer">
                    <Image src="/images/insta/insta10.jpg" width={306} height={306} alt="instaOne" />
                ...
                <div className="mx-auto imageContainer">
                    <Image src="/images/insta/insta6.jpg" width={306} height={306} alt="instaTwo" />
                    <Link href={"https://instagram.com"} target="_blank">
                        <button
                            className="hidden text-white font-semibold absolute z-10"
                            style={{
                ...
                <div className="mx-auto imageContainer">
                    <Image src="/images/insta/insta7.jpg" width={306} height={306} alt="instaThree" />
                    <Link href={"https://instagram.com"} target="_blank">
                        <button
                            className="hidden text-white font-semibold absolute z-10"
                            style={{
                ...
                <div className="mx-auto imageContainer">
                    <Image src="/images/insta/insta8.jpg" width={306} height={306} alt="instaFour" />
                    <Link href={"https://instagram.com"} target="_blank">
                        <button
                            className="hidden text-white font-semibold absolute z-10"
                            style={{
