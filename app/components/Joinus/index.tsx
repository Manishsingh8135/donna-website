        ...
        <div className="bg-joinus my-32">
            <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8'>
                ...
                <div className="text-center">
                    ...
                    <h2 className="text-4xl sm:text-6xl font-bold my-6 leading-10"> Sign Up for the  <br /> Newsletter .</h2>
                    <p className="text-lightblack text-base font-normal">If you wish to be informed of any events being held by Donna McGrath, then sign up here.</p>
                </div>
