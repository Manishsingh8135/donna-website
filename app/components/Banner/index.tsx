            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 my-16'>
                ...
                <div className="mx-auto sm:mx-0">
                    ...
                    <div className="py-3 text-center lg:text-start flex flex-col gap-8">
                        <h1 className='text-6xl lg:text-48xl font-bold text-darkpurple'>
                            Donna McGrath
                        </h1>
                        <h3 className='text-xl lg:text-2xl font-bold text-darkpurple'>
                            ENERGY MASTER & MEDICAL MEDIUM
                        </h3>
                        <h5 className='text-xl lg:text-xl font-bold text-darkpurple'>NIH SCIENTIST, AUTHOR, SPEAKER & TEACHER</h5>
                    </div>
